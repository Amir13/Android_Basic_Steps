...
import com.android.course.handler.HandlerMessage;
import com.android.course.handler.HandlerRunnable;
...
public class MainActivity extends Activity {
	...
	private void handlerRunnable() {
		Button button = (Button) findViewById(R.id.btn_handler_runnable);
		button.setOnClickListener(new OnClickListener() {
	...
	private void handlerMessage() {
		Button button = (Button) findViewById(R.id.btn_handler_message);
		button.setOnClickListener(new OnClickListener() {
